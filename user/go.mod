...
require (
	...
	github.com/Pineana/order v0.0.0
	github.com/go-kratos/kratos/contrib/registry/consul/v2 v2.0.0-20221110032933-b339ae89567d
...
replace github.com/Pineana/order v0.0.0 => ../order
