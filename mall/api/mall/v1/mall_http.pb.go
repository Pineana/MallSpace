...
const OperationMallLogin = "/mall.v1.Mall/Login"
const OperationMallRegister = "/mall.v1.Mall/Register"
...
func RegisterMallHTTPServer(s *http.Server, srv MallHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/register", _Mall_Register0_HTTP_Handler(srv))
	r.POST("/v1/login", _Mall_Login0_HTTP_Handler(srv))
}
