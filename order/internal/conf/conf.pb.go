...
type Server struct {
	...
	Consul *Server_Consul `protobuf:"bytes,3,opt,name=consul,proto3" json:"consul,omitempty"`
	Jaeger *Server_Jaeger `protobuf:"bytes,4,opt,name=jaeger,proto3" json:"jaeger,omitempty"`
}
...
func (x *Server) GetConsul() *Server_Consul {
	if x != nil {
		return x.Consul
	}
	return nil
...
func (x *Server_Consul) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Consul) ProtoMessage() {}

func (x *Server_Consul) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Consul.ProtoReflect.Descriptor instead.
func (*Server_Consul) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Server_Consul) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Server_Consul) GetSchema() string {
	if x != nil {
		return x.Schema
	}
	return ""
...
func (x *Server_Jaeger) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *Data_Database) GetDatabaseName() string {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xf0, 0x03, 0x0a,
	...
	0x63, 0x12, 0x31, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x52, 0x06, 0x63, 0x6f,
	0x6e, 0x73, 0x75, 0x6c, 0x12, 0x31, 0x0a, 0x06, 0x6a, 0x61, 0x65, 0x67, 0x65, 0x72, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x4a, 0x61, 0x65, 0x67, 0x65, 0x72, 0x52,
	0x06, 0x6a, 0x61, 0x65, 0x67, 0x65, 0x72, 0x1a, 0x69, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x12,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x34, 0x0a,
	...
	0x65, 0x6d, 0x61, 0x1a, 0x1a, 0x0a, 0x06, 0x4a, 0x61, 0x65, 0x67, 0x65, 0x72, 0x12, 0x10, 0x0a,
	0x03, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22,
	0xcb, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61,
	...
	0x2e, 0x52, 0x65, 0x64, 0x69, 0x73, 0x52, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x1a, 0xa7, 0x01,
	...
	0x72, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x64, 0x61, 0x74, 0x61, 0x62,
	0x61, 0x73, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0xb3, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_Consul)(nil),       // 5: kratos.api.Server.Consul
	(*Server_Jaeger)(nil),       // 6: kratos.api.Server.Jaeger
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.consul:type_name -> kratos.api.Server.Consul
	6,  // 5: kratos.api.Server.jaeger:type_name -> kratos.api.Server.Jaeger
